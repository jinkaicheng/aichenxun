...
const allowedTiers = new Set(["政务官方", "权威媒体", "企业官方", "专业科技媒体"]);
const risky = /(?:传闻|网传|爆料|内幕|震惊|惊天|泄密|造假|诈骗|犯罪|丑闻|封杀|崩盘|末日|灭绝|杀疯了|彻底怒了|危险阶段|军事|外交|战争|领导人|国家安全|社会事件|事故|灾害|疫情|选举|制裁)/i;
const seen = new Set();
const errors = [];
...
if (articles.length > 24) errors.push("新闻数量超过上限 24");
...
for (const article of articles) {
  ...
  if (risky.test(article.title || "")) errors.push(`${article.title}: 命中风险词`);
